...
def create_design_document_with_diagram():
    doc = Document()
    ...
    r_univ.font.color.rgb = RGBColor(0x0F, 0x4C, 0x81)
    ...
    add_heading_2("1. Modelo Entidad-Relación (E-R) y Diagrama de Flujo")
    doc.add_paragraph(
    ...
    img_filename = "diagrama_er_flujo.png"
    if os.path.exists(img_filename):
        ...
        run_img.add_picture(img_filename, width=Inches(6.3))
        
        p_cap = doc.add_paragraph()
        p_cap.alignment = WD_ALIGN_PARAGRAPH.CENTER
        r_cap = p_cap.add_run("Figura 1. Diagrama de Flujo Entidad-Relación de la Base de Datos Relacional (3FN)")
    ...
    print(f"Document updated successfully with E-R image: {output_filename}")
    ...
    if os.path.exists(artifact_dir):
        ...
        print(f"Artifact document updated at: {artifact_path}")

if __name__ == "__main__":
    create_design_document_with_diagram()
