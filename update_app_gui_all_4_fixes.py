...
# Replace old CTkCalendarPopup class cleanly between 'import calendar' and 'def get_asset_path'
start_idx = content.find("class CTkCalendarPopup(ctk.CTkToplevel):")
end_idx = content.find("def get_asset_path(relative_path):")

content = content[:start_idx] + new_calendar_class + "\n\n" + content[end_idx:]
...
# 4. Update _open_calendar_for_entry callback to auto-trigger _apply_custom_date
...
print("update_app_gui_all_4_fixes complete.")
